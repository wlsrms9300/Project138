	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent active"><a data-toggle="collapse" href="#sub-share-1">
				<em class="fa fa-navicon">&nbsp;</em> 쉐어관리 <span data-toggle="collapse" href="#sub-share-1" class="icon pull-right"><em class="fa fa-minus"></em></span>
				</a>
				<ul class="children collapse in show" id="sub-share-1">
					...
					<li><a class="" href="shareOK.se">
						...
						<li><a class="visited" href="share_settle.se">

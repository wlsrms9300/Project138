...
<link href="${pageContext.request.contextPath}/resources/css/main_default2.css" rel="stylesheet" type="text/css" />
...
<div class="video-container">
	...
	<div class="video-main">
		...
		<img src="${pageContext.request.contextPath}/resources/img/main_test2.PNG"/> <!-- 모바일일때  -->
	</div>
...
<div id="wrapper1">
	<div class="wrapper1_1">
		<p class="main_h1">오늘부터 시작하세요</p><br><br>
		<div class="wrapper1_module">
			<div>
				<i class="fas fa-chess-rook fa-3x"></i>
				<p class="main_h3">새제품처럼</p><br><span class="main_h5">모든 장난감 새로 산것처럼<br>전문가의 꼼꼼한 소독처리</span>
			</div>
			<div>
				<i class="fas fa-gift fa-3x"></i>
				<p class="main_h3">기념일에도</p><br><span class="main_h5">아이들의 생일에도<br>깜짝 이벤트에도</span>
			</div>
			<div>
				<i class="fas fa-box fa-3x"></i>
				<p class="main_h3">안전 배송</p><br><span class="main_h5">꼼꼼하고 재활용이 가능한<br>튼튼한 박스로 쓰윽 배송</span>
			</div>
		</div>
	</div>
	...
	<div class="wrapper3_module">
		<div class="wrapper3_1">
			...
			<div class="wrapper3_btn1">
				<button type="button" name="join_btn" class="join_btn1" onclick="location.href='signup.me'">회원가입</button>
				<br>
				<button type="button" name="sub_btn" class="sub_btn1" onclick="location.href='subscribestep1.me'">구독신청</button>
			</div>
		</div>
		<div class="wrapper3_2">
			<div class="wrapper3_module1">
				<div class="wrapper3_step1" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="200">
					<span><h3>STEP. 1</h3><br>회원가입</span>
				</div>
				<div class="wrapper3_step2" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300">
					<span><h3>STEP. 2</h3><br>구독 신청 후<br>요금제 선택</span>
				</div>
				<div class="wrapper3_step3" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="400">

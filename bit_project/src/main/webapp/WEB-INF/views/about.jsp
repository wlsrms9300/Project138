...
<body>
	...
	<div class="intro-section">
		...
		<div class="intro_second">
			...
			<span class="span_style" data-aos="fade-up" data-aos-duration="1000">1단계 - 간단히 회원 가입을 완료한 후<br>
				2단계 - 원하시는 구독 종류를 선택하시고<br> 3단계 - 좋아하거나 원하는 장난감을 골라 위시리스트에
				추가합니다.<br> 4단계 - 장난감이 문앞으로 배송되기를 기다리면 끝
	...
	<div class="intro-section1">
		...
		<div class="mt_2 img2 span_style" data-aos="fade-up" data-aos-duration="1000">
			<span><i class="fas fa-dice-one fa-3x"></i></span> <span>2회 이상
				파손 및 분실 시 서비스 이용에 제한될 수 있으니 이점 양해 부탁드립니다.</span>
		</div>
		<br> <br> <br>
		<div class="mt_3 img2 span_style" data-aos="fade-up" data-aos-duration="1000">
			<span><i class="fas fa-dice-two fa-3x"></i></span> <span>구독이
				처음이신 분들을 위해 체험(1개월,2개월) 서비스를 추천해 드립니다.</span>
		</div>
		<br> <br> <br>
		<div class="mt_4 img2 span_style" data-aos="fade-up" data-aos-duration="1000">
			<span><i class="fas fa-dice-three fa-3x"></i></span> <span>아동
		...
		<div class="mt_5 img2 span_style" data-aos="fade-up" data-aos-duration="1000">
			<span><i class="fas fa-dice-four fa-3x"></i></span> <span>개인
				SNS(인스타그램)에 리뷰를 작성해주시면 500point 지급해드립니다.<br> 포인트는 구독료 차감 가능하며
				특별한 날에 오래 기억될 선물 포장 서비스에도 사용 가능합니다.
			</span>
		</div>
	</div>
